...
const INSPIRATION_SERVICE = 'INSPIRATION_SERVICE';
const IS_PUBLIC = 'launchpad:public';

module.exports = { STORE_TOKEN, AUTH_SERVICE, GENERATOR_SERVICE, PROJECTS_SERVICE, CATALOG_SERVICE, INSPIRATION_SERVICE, IS_PUBLIC };
