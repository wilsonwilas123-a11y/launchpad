    ...
    <section className="relative overflow-hidden py-24 sm:py-36">
      <div className="shell">
        <Reveal className="relative mx-auto max-w-[720px] text-center">
          ...
          <h2 className="font-display text-[clamp(2.1rem,5.6vw,3.5rem)] font-medium leading-[1.02] tracking-[-0.04em] text-white text-shadow-soft">
            Your idea deserves
            <br />a launch.
          </h2>
          <p className="mx-auto mt-5 max-w-[46ch] text-[16px] leading-relaxed text-ink-200">
